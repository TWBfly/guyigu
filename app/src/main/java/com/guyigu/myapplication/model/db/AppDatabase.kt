...
import com.guyigu.myapplication.model.db.entity.GroupEntity
 ...
 */
@Database(entities = [UserEntity::class,FriendEntity::class,GroupEntity::class],version = 1, exportSchema = false)
